...
class PurchaseSummaryPage extends StatelessWidget {
  const PurchaseSummaryPage({Key? key}) : super(key: key);
                ...
                children: [
                  ...
                  Consumer2<MainProvider, SaleProvider>(
                    builder: (context, mainProvider, saleProvider, widget) =>
                      ...
                      child: SizedBox(
                        height:
                            saleProvider.cartProducts.length == 1 ? 270 : 400,
                        width: 350,
                        child: ClipPath(
                  ...
                  Consumer<SaleProvider>(
                    ...
                    return (mainProvider.cafeteriaSetting?.openpayRecharge ==
                                true &&
                            !saleProvider.paySaleWithBalance)
                        ? Column(
                            children: [
                              Container(
                  ...
                  Padding(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          if (mainProvider.cafeteriaSetting?.openpayRecharge ==
                              true)
                            Consumer2<SaleProvider, MainProvider>(builder:
                                (context, saleProvider, mainProvider, child) {
                              return Row(
                                ...
                                children: [
                                  Transform.scale(
                                    ...
                                    child: Switch(
                                      value: saleProvider.paySaleWithBalance,
                                      activeTrackColor:
                                          colors.tuitionGreen.withOpacity(0.2),
                                      inactiveTrackColor:
                                          Colors.grey.withOpacity(0.2),
                                      activeColor: colors.tuitionGreen,
                                      inactiveThumbColor:
                                          Colors.grey.withOpacity(0.8),
                                      onChanged: (value) => saleProvider
                                          .changePayWithCardOption(value),
                                    ),
                                  ),
                                  const SizedBox(
                                    width: 5,
                                  ...
                                  Text(
                                    "${AppLocalizations.of(context)!.pay_with_balance} (\$${mainProvider.familyBalance})",
                                                        ...
                                                        if (mainProvider
                                                          ...
                                                          if (mainProvider
                                                            ...
                                                            Navigator.of(
                                                              ...
                                                              router
                                                                  .successfulSaleIndependentSaleRoute,
                                                              arguments: SuccessfulSaleArguments(
                                                                  total:
                                                                      totalPriceCopy,
                                                                  folio: saleProvider
                                                                      .successfulSaleId,
                                                                  saleDate: DateFormat("dd/MM/yyyy HH:mm")
                                                                      .format(DateTime
                                                                          .now())
                                                                      .toString(),
                                                                  scheduledDate: saleProvider.saleType != "PS"
                                                                  ...
                                                                  surchargeSaleType: mainProvider
                                                                      .cafeteriaSetting!
                                                                      .surchargeSaleType,
                                                                  surchargeSaleAmount: mainProvider.cafeteriaSetting!.surchargeSaleAmount,
                                                                  surchargeSaleActivated: mainProvider.cafeteriaSetting!.surchargeSale),
                                                            );
                                                          } else {
                                                            if (saleProvider
                                                                    .saleType ==

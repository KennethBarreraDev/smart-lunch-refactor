                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () {
                          /*
                        print("Elemento");
                        print(mainProvider.selectedChild?.limitedProducts[product.id]);
                        print(mainProvider.selectedChild?.limitedProducts);
                        print(saleProvider.cart);*/
                          ...
                          if (mainProvider.userType == UserRole.teacher) {
                            addItems.call(product);
                                  ...
                                  0 ||
                              (saleProvider.totalPrice + product.price) <=
                                  mainProvider.selectedChild!.dailySpendLimit) {
                            if (mainProvider
                                    .selectedChild?.limitedProducts[product.id] !=
                                null) {
                              int maximumAmount = 0;
                              maximumAmount = mainProvider.selectedChild
                                      ?.limitedProducts[product.id] ??
                                  0;
                              if (saleProvider.cart[product.id] != null &&
                                  saleProvider.cart[product.id]! >=
                                      maximumAmount) {

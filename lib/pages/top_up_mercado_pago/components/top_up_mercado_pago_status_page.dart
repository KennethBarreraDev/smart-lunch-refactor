...
class MercadoPagoTopUpStatusPage extends StatelessWidget {
  const MercadoPagoTopUpStatusPage(
      {Key? key,
  ...
  Widget build(BuildContext context) {
    ...
    topUpStatusProvider.fetchData(paymentId, merchantOrderId, externalReference,
            ...
            Stack(
              children: [
                ...
                Consumer<TopUpStatusProvider>(
                    builder: (context, topUpStatusProvider, widget) => Column(
                          children: [
                            const SizedBox(
                              height: 27,
                            ),
                                              ...
                                              return RichText(
                                                text: TextSpan(
                                                  children: [
                                                    ...
                                                    TextSpan(
                                                      text:
                                                          (homeProvider.cafeteria?.school.country ?? "") == Contries.panama ? " USD" : " MXN",
                                                      style: const TextStyle(
                                                        color: colors.darkBlue,
                                                        fontSize: 16.0,
                                                      ),
